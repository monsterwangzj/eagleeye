...
if (daysMode == null) {
	pageLinkBase = "/alarm/notresume.do?p=";
} else {
	pageLinkBase = "/alarm/notresume.do?mode=" + daysMode;
				...
				<div class="w_left">
					<div class="w_210 bc">
						...
						<ul class="list">
							...
							<li class="current"><span class="point">&nbsp;</span><a href="/alarm/notresume.do">尚未恢复项目</a></li>
...
car.on("choose", function(e){
	...
	arr.sort();
	if(arr.length == 2) {
		location.href = base + "/alarm/notresume.do?mode=-1&start=" + arr[0] + "&end=" + arr[1];
	}
});
var isShow = true;
