...
%><%@ page import="java.util.*,com.chengyi.eagleeye.model.assist.HttpOption,net.sf.json.JSONObject,com.chengyi.eagleeye.model.*,org.apache.commons.collections.CollectionUtils" 
%><%
...
HttpOption httpOption = (HttpOption) JSONObject.toBean(optionJSON, HttpOption.class);
...
<div class="bg01">
    <div class="con">
      ...
      <form name="form1" method="post" action="/item/update.do">
      ...
      <table cellpadding="0" cellspacing="0" border="0" style="width:910px;margin-bottom:100px;margin-left:48px;">
          ...
          <tr class="shidden">
              ...
              <td width="87%" colspan="3" id="box1">
              	<span data="GET">
              		<span class="ra01 <%=(httpOption.getHttpMethod().equalsIgnoreCase("get") ? "ra02" : "")%>" style="margin-left:0px;"></span>
              		<span style="margin-left:0px;">GET</span>
              	</span>
              	<span data="POST">
              		<span class="ra01 <%=(httpOption.getHttpMethod().equalsIgnoreCase("post") ? "ra02" : "")%>" style="margin-left:0px;"></span>
          ...
          <tr class="shidden">
              ...
              <td width="87%" colspan="3"><input name="timeout" type="text" value="<%=httpOption.getHttpTimeout() %>" style="width:180px;">&nbsp;毫秒</td>
          </tr>
          <tr class="shidden">
              <td width="13%" class="ri"></td>
          ...
          <tr class="shidden">
              ...
              <td width="87%" colspan="3"><textarea name="resultmatchpattern" cols="" rows="3"><%=httpOption.getResultMatchPattern() == null ? "" : httpOption.getResultMatchPattern()%></textarea></td>
          </tr>
          <tr class="tip shidden">
              <td width="13%" class="ri"></td>
          ...
          <tr class="shidden">
              ...
              <td width="87%" colspan="3" id="box2">
              	<span data="包含匹配内容">
              		<span class="ra01 <%=(httpOption.getResultMatchPatternStatus() == (byte) 1 ? "ra02" : "")%>" style="margin-left:0px;"></span>
              		<span style="margin-left:0px;">包含匹配内容</span>
             	</span>
              	<span data="不包含匹配内容">
              		<span class="ra01 <%=(httpOption.getResultMatchPatternStatus() == (byte) 0 ? "ra02" : "")%>" " style="margin-left:0px;"></span>
          ...
          <tr class="shidden">
              ...
              <td width="87%" colspan="3"><textarea name="cookies" cols="" rows="3"><%=(httpOption.getCookies()==null?"":httpOption.getCookies())%></textarea></td>
          </tr>
          <tr class="tip shidden">
              <td width="13%" class="ri"></td>
...
token=d906b69209d9de92789fcd65a1a5d210; pvid=954970634; flv=10.0</td>
          ...
          <tr class="shidden">
              ...
              <td width="87%" colspan="3"><textarea name="httpheader" cols="" rows="3"><%=(httpOption.getHttpHeader()==null?"":httpOption.getHttpHeader())%></textarea></td>
              <td></td>
          </tr>
          <tr class="tip shidden">
              <td width="13%" class="ri"></td>
          ...
          <tr class="shidden">
              ...
              <td width="87%" colspan="3"><textarea name="alarmmsg" cols="" rows="3"></textarea></td>
          </tr>
          <tr class="tip shidden">
              <td width="13%" class="ri"></td>
          ...
          <tr class="shidden">
              ...
              <td width="87%" colspan="3"><input name="serverips" type="text" value="<%=(httpOption.getServerIps()==null?"":httpOption.getServerIps())%>" class="longinput" style="width: 400px;"></td>
          </tr>
          <tr class="tip shidden">
              <td width="13%" class="ri"></td>
          ...
          <tr>
          	<td width="100%" colspan="4"><div class="fx_top1" style="width:98%;">
		      	<div class="fx_top1L fx_top2L" style="width:13%;margin-left:-48px;">设置常规告警通知</div><div class="fx_top1R fx_top2R" style="width:83%;"></div>
		    </div></td>
          </tr>
          <tr>
