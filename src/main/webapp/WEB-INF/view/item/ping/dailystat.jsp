    ...
    <td class="noline">PING</td>
      ...
      <div class="w_960 pt">
          ...
          <div class="w_735">
              ...
              <p class="fr pr">
              		<span><a <%=( daysMode.equals("7") ? "class=\"on\"" : "")%> href="/pingitem/dailystat2.do?itemId=<%=item.getId()%>&mode=7">最近7天</a></span>
              		<span><a <%=( daysMode.equals("15") ? "class=\"on\"" : "")%> href="/pingitem/dailystat2.do?itemId=<%=item.getId()%>&mode=15">最近15天</a></span>
              		<span><a <%=( daysMode.equals("30") ? "class=\"on\"" : "")%> href="/pingitem/dailystat2.do?itemId=<%=item.getId()%>&mode=30">最近30天</a></span>
