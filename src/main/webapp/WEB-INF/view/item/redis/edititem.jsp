...
//PingOption pingOption = (PingOption) JSONObject.toBean(item.getOptions(), PingOption.class);
...
<div class="bg01">
    <div class="con">
      ...
      <div class="b_bg mt" >
      <div class="title"><h4>编辑监控项目> redis监控</h4></div>
      <div class="fx_top1" style="overflow:hidden;">
      	<div class="fx_top1L">填写监控信息</div><div class="fx_top1R"></div>
      </div>
      <form name="form1" method="post" action="/redisitem/update.do">
      ...
      <table cellpadding="0" cellspacing="0" border="0" style="width:910px;margin-bottom:100px;margin-left:48px;">
          ...
          String options = item.getOptions();
	  	  if (StringUtils.isNotEmpty(options)) {
	  			...
	  			redisServerIp = jobj.getString("redisServerIp");
	  			redisServerPort = jobj.getString("redisServerPort");
	  	  }
          ...
          <tr>
              <td width="13%" class="ri" colspan="4" id="simpleMode">
              	<span data="simpleMode">
              		<span class="ra01 <%=(StringUtils.isNotEmpty(options) ? "ra02" : "") %>" style="margin-left:0px;"></span>
          ...
          <tr>
              ...
              <td width="84%" colspan="3"><input name="redisServerIp" type="text" size="40" value="<%=redisServerIp %>" class="longinput" style="width: 280px;"/><font style="margin-left:10px;color:#f00;">*</font></td>
          	  </tr>
          	  </table>
          	  </td>
          </tr>
          	  ...
          	  <table style="margin-top: 0px; margin-bottom: 0px;">
	          	  <tr>
		              <td width="16%" class="ri">redis服务端口：</td>
              		  <td width="84%" colspan="3"><input name="redisServerPort" type="text" size="40" value="<%=redisServerPort %>" style="width: 150px;"/><font style="margin-left:10px;color:#f00;">*</font></td>
	              </tr>
          	  </table>
          	  </td>
          </tr>
          ...
          <tr>
              <td width="13%" class="ri" colspan="4" id="secureMode">
              	<span data="secureMode">
              		<span class="ra01 <%=(StringUtils.isEmpty(options) ? "ra02" : "") %>" style="margin-left:0px;"></span>
          ...
          <tr height="10">
          	  ...
          	  <table style="margin-top: 0px; margin-bottom: 0px;">
	          	  <tr>
	                  ...
	                  <td width="84%" colspan="3"><input name="url" type="text" size="120" value="<%=url %>" class="longinput" style="width: 400px;"/><font style="margin-left:10px;color:#f00;">*</font></td>
				  </tr>
          	  </table>
          	  </td>
          </tr>
         ...
         <%-- 
          <tr class="shidden">
              ...
              <td width="87%" colspan="3"><input name="serverips" type="text" value="" class="longinput" style="width: 400px;"></td>
          </tr>
