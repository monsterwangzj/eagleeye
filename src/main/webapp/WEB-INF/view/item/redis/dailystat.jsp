...
%><%@ page import="com.chengyi.eagleeye.model.assist.RedisOption,com.chengyi.eagleeye.model.assist.HttpOption,java.text.NumberFormat,java.util.*,net.sf.json.JSONObject,com.chengyi.eagleeye.model.*,org.apache.commons.collections.CollectionUtils" 
%><%
    ...
    <td class="noline">REDIS</td>
      ...
      <div class="w_960 pt">
           <div class="w_left">
              ...
              <ul class="list">
              	  <li class="noline" ><span class="point">&nbsp;</span><a href="/redisitem/summary.do?itemId=<%=item.getId()%>">概况</a></li>
              	  <li class="current"><span class="point">&nbsp;</span><a href="#">每日统计</a></li>
              </ul>
             </div>
          ...
          <div class="w_735">
              ...
              <p class="fr pr">
              		<span><a <%=( daysMode.equals("7") ? "class=\"on\"" : "")%> href="/redisitem/dailystat2.do?itemId=<%=item.getId()%>&mode=7">最近7天</a></span>
              		<span><a <%=( daysMode.equals("15") ? "class=\"on\"" : "")%> href="/redisitem/dailystat2.do?itemId=<%=item.getId()%>&mode=15">最近15天</a></span>
              		<span><a <%=( daysMode.equals("30") ? "class=\"on\"" : "")%> href="/redisitem/dailystat2.do?itemId=<%=item.getId()%>&mode=30">最近30天</a></span>
