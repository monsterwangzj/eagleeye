    ...
    <div class="con">
      ...
      <table cellpadding="0" cellspacing="0" border="0" style="width:910px;margin-bottom:100px;margin-left:48px;">
          ...
          <tr>
              ...
              <td width="87%" colspan="3">PING监控</td>
          </tr>
           <tr>
              <td width="13%" class="ri">主机域名或IP：</td>
          ...
          <tr>
              <td width="13%" class="ri"></td>
              <td  width="87%" colspan="3" class="tip">比如：monitor.ku6.com 或者 122.11.33.188</td>
          </tr>
...
$("#btnSubmit").click(function() {
	...
	if(!CheckIpnDomain($('input[name="url"]').val())) {
		layer2.un().show(function(el) {
			el.pan.find("p").html("请填写正确的主机域名或IP地址！");
			el.pan.find(".button01").hide().eq(0).show();;
		});
		return false;
	}
