...
public class RetryResinThread implements Runnable {
	private static final Logger logger = Logger.getLogger(RetryResinThread.class);

	private ApacheParam apacheParam;
	private Item item;

	public RetryResinThread(Item item, ApacheParam apacheParam) {
