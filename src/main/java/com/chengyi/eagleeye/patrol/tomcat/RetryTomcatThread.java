...
public class RetryTomcatThread implements Runnable {
	private static final Logger logger = Logger.getLogger(RetryTomcatThread.class);

	private ApacheParam apacheParam;
	private Item item;

	public RetryTomcatThread(Item item, ApacheParam apacheParam) {
