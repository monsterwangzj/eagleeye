...
public class StatNginxMessage {
	private static Logger logger = Logger.getLogger(StatNginxMessage.class);
	...
	private static final String nginxMessageStartTimeKey = ApplicaRuntime.globalFlag + "statkey_nginx_message_starttime";
...
//				}
	...
	public void schedule() {
		try {
			...
			while (startTime < currentTime) {
				...
				deleteExpiredData(formatEndTime); // 删除1天前的数据
	...
	private Long getNginxMessageStartTime() {
		...
		if (startTime == null) {
			startTime = 1396500000000L; // 2014-02-12 22:00:00
		}
		return startTime;
	}
	...
	public void deleteExpiredData(long endTime) {
